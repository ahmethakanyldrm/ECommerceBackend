    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Register(Models.Account.RegisterModels user)
        {
            try
            {
                ...
                {
                    throw new Exception("Zaten Bu E-Posta Kayıtlı");
                }
        ...
        public ActionResult Login(Models.Account.LoginModels model)
        {
            try
            {
                var user = context.Members.
                    FirstOrDefault(x => x.Password == model.Member.Password && x.Email == model.Member.Email);
                ...
                {
                    ViewBag.ReError = "Bilgileriniz Hatalı";
                    return View();
                }
            }
            catch (Exception ex)
        ...
        public ActionResult ForgotPassword(string email)
        {
            ...
            if (member==null)
            {
                ViewBag.MyError = "Bu Mail Adresi Kayıtlı Değil";
                return View();
            }
            else
            {
