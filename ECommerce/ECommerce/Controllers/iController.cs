...
namespace ECommerce.Controllers
{
    public class iController : BaseController
    {
        ...
        {
            // kategori id lerine göre ürünleri listeleme
            IQueryable<DB.Products> products = context.Products.OrderByDescending(x => x.AddedDate).
        ...
        public ActionResult Buy()
        {
            if (IsLogon())
            {
                ...
                foreach (var item in orders)
                {
                    ...
                    byModel.OrderName = string.
                    Join(", ", item.OrderDetails.Select(y => y.Products.Name + "(" + y.Quantity + ")"));
  ...
  Format("{0} ürünü için yeterli stok yoktur veya silinmiş bir ürünü almaya çalışıyorsunuz", item.Product.Name));
